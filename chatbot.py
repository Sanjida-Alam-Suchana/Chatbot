...
class ChatBot:
     ...
     def send(self):
         ...
         elif 'Semesters' in p or 'semester' in p:
             self.text.insert(END,'\n'+'Bot: 2 Semesters.Each academic year is divided into 2 Semesters (Spring Semester and Autumn Semester) having a duration 15 week Lecture period for each semester. The Mid-term Examination will be held after conducting 6 weeks classes.' +'\n')
